        ...
        Object.keys(usersEvents).forEach(function (key) {
            ...
            eventsList.push(
                <VerticalTimelineElement
                    ...
                    date={event_datetime.toLocaleDateString() + " " + event_datetime.toLocaleTimeString()}
                    iconStyle={{background: 'rgb(33, 150, 243)', color: '#fff'}}
                    icon={<FcCalendar/>}
                >
                    <h3 className="vertical-timeline-element-title">{usersEvents[key].title}</h3>
                    <h4 className="vertical-timeline-element-subtitle">{usersEvents[key].scope}</h4>
                    <p>
                        {usersEvents[key].description}
                    </p>
                    <MyButton>124</MyButton>
                </VerticalTimelineElement>
            );
        });
        return eventsList
